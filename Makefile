#############################################################################
# Makefile for building: start
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri Jul 28 17:17:54 2017
# Project:  start.pro
# Template: app
# Command: /usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/qmake -spec /usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/default -unix CONFIG+=debug CONFIG+=declarative_debug -o Makefile start.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		sec_dialog.cpp \
		third_dialog.cpp moc_mainwindow.cpp \
		moc_sec_dialog.cpp \
		moc_third_dialog.cpp
OBJECTS       = main.o \
		mainwindow.o \
		sec_dialog.o \
		third_dialog.o \
...
$(TARGET): ui_mainwindow.h ui_sec_dialog.h ui_third_dialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: start.pro  /usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/default/qmake.conf /usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/common/g++.conf \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/common/unix.conf \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/common/linux.conf \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/common/qws.conf \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec /usr/local/Trolltech/QtEmbedded-4.6.3-arm/mkspecs/default -unix CONFIG+=debug CONFIG+=declarative_debug -o Makefile start.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/start1.0.0/ && $(COPY_FILE) --parents mainwindow.h sec_dialog.h third_dialog.h .tmp/start1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp sec_dialog.cpp third_dialog.cpp .tmp/start1.0.0/ && $(COPY_FILE) --parents mainwindow.ui sec_dialog.ui third_dialog.ui .tmp/start1.0.0/ && (cd `dirname .tmp/start1.0.0` && $(TAR) start1.0.0.tar start1.0.0 && $(COMPRESS) start1.0.0.tar) && $(MOVE) `dirname .tmp/start1.0.0`/start1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/start1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_sec_dialog.cpp moc_third_dialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_sec_dialog.cpp moc_third_dialog.cpp
moc_mainwindow.cpp: mainwindow.h
	/usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/moc $(DEFINES) $(INCPATH) mainwindow.h -o moc_mainwindow.cpp

moc_sec_dialog.cpp: sec_dialog.h
	/usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/moc $(DEFINES) $(INCPATH) sec_dialog.h -o moc_sec_dialog.cpp

moc_third_dialog.cpp: third_dialog.h
	/usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/moc $(DEFINES) $(INCPATH) third_dialog.h -o moc_third_dialog.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_sec_dialog.h ui_third_dialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_sec_dialog.h ui_third_dialog.h
ui_mainwindow.h: mainwindow.ui
	/usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/uic mainwindow.ui -o ui_mainwindow.h

ui_sec_dialog.h: sec_dialog.ui
	/usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/uic sec_dialog.ui -o ui_sec_dialog.h

ui_third_dialog.h: third_dialog.ui
	/usr/local/Trolltech/QtEmbedded-4.6.3-arm/bin/uic third_dialog.ui -o ui_third_dialog.h
...
sec_dialog.o: sec_dialog.cpp sec_dialog.h \
		ui_sec_dialog.h \
		third_dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sec_dialog.o sec_dialog.cpp

third_dialog.o: third_dialog.cpp third_dialog.h \
		ui_third_dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o third_dialog.o third_dialog.cpp

moc_mainwindow.o: moc_mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mainwindow.o moc_mainwindow.cpp

moc_sec_dialog.o: moc_sec_dialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_sec_dialog.o moc_sec_dialog.cpp

moc_third_dialog.o: moc_third_dialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_third_dialog.o moc_third_dialog.cpp
